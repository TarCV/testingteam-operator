...
import static com.github.tarcv.tongs.reporter.TongsReporter.Builder.tongsReporter;

public class TongsReporterCli {
    private static final Logger logger = LoggerFactory.getLogger(TongsReporterCli.class);

    private TongsReporterCli() {}
    ...
    public static class CommandLineArgs {
        ...
        @Parameter(names = { "--baseUrl" }, description = "The base URL where the report will be pointing to. " +
                ...
                "The location it points to should contain an /html folder that tongs creates at each execution." +
                "E.g. http://build-server.com/master/{BUILD_ID}/tongs/", required = false)
