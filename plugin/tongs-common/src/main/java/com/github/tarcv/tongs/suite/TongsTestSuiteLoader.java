...
public class TongsTestSuiteLoader implements TestSuiteLoader {
    ...
    private static final String REVOKE_PERMISSION_ANNOTATION = "Lcom/shazam/tongs/RevokePermission;";
    private static final String TEST_PROPERTIES_ANNOTATION = "Lcom/shazam/tongs/TestProperties;";
    ...
    public TongsTestSuiteLoader(File instrumentationApkFile, DexFileExtractor dexFileExtractor, TestClassMatcher testClassMatcher) {
