...
public class TestRunListenersFactoryInjector {
    ...
    public static TestRunListenersFactory testRunListenersFactory(TongsConfiguration configuration) {
        return new TestRunListenersFactory(configuration, GsonInjector.gson());
    }
}
